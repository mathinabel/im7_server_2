...
@RestController
public class AddFriendRequestBack {
    @Autowired
    RabbitTemplate rabbitTemplate;  //使用RabbitTemplate,这提供了接收/发送等等方法

    @Autowired
    private RestTemplate restTemplate;
    @PostMapping("/addFriendRequestBack")
    public String addFriendRequestBack(HttpServletRequest request) {
...
//发mysql
        ...
        String str = restTemplate.postForObject("http://im-sql-save/addFriendSave",request2
                ,String.class);
